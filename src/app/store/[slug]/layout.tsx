...
export default async function StorefrontLayout({
    ...
    if (store.status !== 'approved') {
        return (
            <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', background: '#FAFAFA', fontFamily: 'IBM Plex Sans Arabic, Inter, sans-serif' }}>
                <div style={{ fontSize: 60, marginBottom: 16 }}>🛠️</div>
